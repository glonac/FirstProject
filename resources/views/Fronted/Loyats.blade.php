...
<head>
    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow" id="header">
        ...
        <nav class="my-2 my-md-0 mr-md-3">
            ...
            <a class="p-2 text-dark" href="Personal">Персонал</a>
...
<footer class="container-fluid " id="footer">
    ...
    <div class="col-12 col-md">
            ...
            <ul class="list-unstyled text-small">
                <li><a class="text-muted" href="#">Ермака 150</a></li>
            </ul>
        </div>
    <div class="col-6 col-md">
            <h5>Номер</h5>
            <ul class="list-unstyled text-small">
                <li><a class="text-muted" href="#">8999999</a></li>
            </ul>
        </div>
        <div class="col-6 col-md">
